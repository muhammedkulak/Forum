...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <link rel="stylesheet" type="text/css" href="style/fancybox/jquery.fancybox.css" media="screen" />
        ...
        <title><?php echo $logo;?> İtiraf - Üye Ol</title>
...
</div><script>$('#mn-uyeol').addClass('selected');</script>
...
<div class='content-container'>
  <div class='content'>
    <div class='sayfa'>
            ...
            <div class='uyelik'><form action='kayit.php' method='post'>
        <p><span>Nick:</span>         <span class='sag'><input type='text' id='nick' name='nick' maxlength=20 value='' /></span></p>
        <p><span>Şifre:</span>        <span class='sag'><input type='password' id='pass' name='pass' value='' /></span></p>
        <!--<p><span>Şifre Tekrar:</span> <span class='sag'><input type='password' id='pass2' name='pass2' value='' /></span></p>-->
        <p><span>E-Mail:</span>       <span class='sag'><input type='text' id='email' name='email' value='' /></span>Aktivasyon için gerekli!<br></p>

        
        <p><span>Cinsiyet:</span>
          <label><input type="radio" name="cinsiyet" value="1" id="cinsiyet_0" /> Erkek</label>
          <label><input type="radio" name="cinsiyet" value="2" id="cinsiyet_1" /> Bayan</label>
        </p>

        <p><input type='submit' name='gonder' id='gonder' value='Üye Ol'/></p>
      </form></div>
