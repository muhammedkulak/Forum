...
</div><script>$('#mn-uyegiris').addClass('selected');</script>
...
<!--        <center>
        ...
        <div class='uyelik login'><form name="login" action='login.php' method='post'>
        <p><span>Nick:</span>  <span class='sag'><input type='text' id='nick' name='nick' value='' /></span></p>
        <p><span>Şifre:</span> <span class='sag'><input type='password' id='pass' name='pass' value='' /></span></p>
            <input type='submit' name='gonder' id='gonder' value='Giriş'/>
<br><br>
        <p>
        <a href='sifremiunuttum.php'>Şifremi Unuttum</a>
        </p>
        <p>Aktivasyon maili gelmediyse <a href="aktivasyon.php">tıklayınız..</a>
        </p>    
      </form>
        </div>
